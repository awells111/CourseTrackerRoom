        ...
        if (term().count() == 0) {
            ...
            try {
                ...
                for (int i = 0; i < Term.TERMS.length; i++) {
                    ...
                    course.setStatus("Plan To Take"); //Needs to match up with R.string.plan_to_take
                    course.setStartDate(2592000000L * i);
                    course.setEndDate(2592000000L * (i * 2));
                    course.setTermId(i + 1); //+1 because autogenerated IDs start at 1

                    CourseMentor courseMentor = new CourseMentor();
                    courseMentor.setName("Teacher " + Integer.toString(i));
                    courseMentor.setPhoneNumber("1111111111");
                    courseMentor.setEmail("teacher@email.com");
